<template>
  <footer class="d-flex flex-column mt-8 align-center justify-center w-100 pa-3">
    ...
    <div class="d-flex align-center my-4 justify-center w-100">
      ...
      <a href="https://github.com/biomousavi" class="font-weight-bold text-caption mx-1">
        biomousavi
      </a>
    </div>
  </footer>
